...
export interface DatePickerViewPropsType extends Pick<PickerViewPropsType, 'style' | 'itemStyle' | 'numberOfLines' | 'renderMaskTop' | 'renderMaskBottom' | '_ScrollViewComponent'> {
    value?: PickerDate;
