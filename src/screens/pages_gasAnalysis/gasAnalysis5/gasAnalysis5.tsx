import { Dimensions, Image, PixelRatio, Pressable, SafeAreaView, StyleSheet, Text, View } from 'react-native'
...
export class GasAnalysis5 extends Component<any,any> {
    ...
    getData=()=>{
        ...
        let queryData = [];
        //查询数据
        HttpService.apiPost(api.qnjc_gases_getData, {
            userId: userId,
        ...
        return (
            <View style={{flex: 1}}>
                ...
                <SafeAreaView style={{flex: 1}}>
                    {/* 引入自定义导航栏 */}
                    <Navbar 
                        pageName={t('gasEnergyCollection')}
                        showBack={true}
                        showHome={false}
                        isCheck={3}
                            ...
                            {this.state.optionData.length == 0?
                                ...
                                <View style={styles.table}>
                                    <View style={styles.row}>
                                        ...
                                        <Text allowFontScaling={false} style={styles.th}>{t('startingData')}</Text>
                                        <Text allowFontScaling={false} style={styles.th}>{t('cutoffData')}</Text>
                                        <Text allowFontScaling={false} style={styles.th}>{t('cutoffData')}</Text>
                                    </View>
