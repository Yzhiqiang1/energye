import { Text, View, Dimensions, Image, ScrollView, Pressable, SafeAreaView, PixelRatio } from 'react-native'
    ...
    render() {
        return (
            <SafeAreaView 
                ...
                ></Navbar>
                {/* 内容 */}
                <ScrollView style={[styles.containerMini,{height:this.state.boxHeight-ht/8-ht/8}]}>
